...
{
    const USER = 'Bendbennett\DemoBundle\Document\User';
    const USER_COMPANY = 'Bendbennett\DemoBundle\Document\UserCompany';
    ...
    private function deserializeFromJson(string $dataToDeserialize, string $document, string $dataToDeserializeFormat, string $id = null, string $idName = null)
    {
